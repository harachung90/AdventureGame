...
public class Main {
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            if (health < 1) { // out of the loop because health is below 1
            ...
            if (rand.nextInt(100) < healthPotionDropChance) { // after the defeat, the enemy drops a health potion (random chance)
                numHealthPotions++;
